...
export function Skills() {
  ...
  return (
    <section id="skills" className="scroll-mt-24 border-y border-border bg-card py-24">
            ...
            >
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {group.items.map((item) => (
                  <span
                    key={item}
                    className="rounded-lg border border-border bg-card px-3 py-1.5 text-xs font-medium transition-colors hover:border-primary/50 hover:text-primary"
                  >
                    {item}
                  </span>
                ))}
