      ...
      <div className="mx-auto max-w-6xl px-5">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {certifications.map((cert, i) => {
            const isPdf = Boolean(cert.image?.toLowerCase().includes(".pdf"));
            return (
              <Reveal key={cert.id} delay={i * 90} as="article">
                ...
                >
                  <div className="relative aspect-[4/3] w-full border-b border-border bg-background p-2 sm:p-3">
                    {cert.image ? (
                      isPdf ? (
                        <object
                          data={cert.image}
                        ...
                        >
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="grid size-full place-items-center text-sm text-primary underline"
                          >
