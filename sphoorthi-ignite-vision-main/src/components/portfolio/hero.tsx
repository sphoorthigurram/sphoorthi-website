...
function CopyEmail() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface px-5 py-3 font-mono text-xs tracking-wide text-muted-foreground transition-colors hover:border-primary/50 hover:text-primary"
    >
  ...
  return (
    <section id="top" className="relative overflow-hidden pt-32 pb-16 sm:pt-40">
      ...
      <div className="relative mx-auto max-w-6xl px-5">
        ...
        <Reveal delay={80}>
          <h1 className="mt-7 text-5xl font-semibold leading-[0.95] sm:text-7xl lg:text-8xl">
            Sphoorthi
            <br />
            Gurram
          </h1>
        ...
        <Reveal delay={260} className="mt-9 flex flex-wrap items-center gap-3">
          ...
          <a
            href="#contact"
            className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface px-5 py-3 text-sm font-semibold transition-colors hover:border-primary/50 hover:text-primary"
          >
            Get in Touch
          </a>
          <CopyEmail />
