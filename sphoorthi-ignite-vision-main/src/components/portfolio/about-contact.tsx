        ...
        <div>
          ...
          <Reveal delay={80} className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground">
            <p>
              ...
              at the seam between physical power and machine reasoning: one week
              I&apos;m tuning a GaN totem-pole PFC stage for a bidirectional EV charger, the next
              I&apos;m writing a LIDAR raycast engine so a humanoid robot can understand a room.
            </p>
            <p>
          ...
          <Reveal delay={140} className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={item.k} className="rounded-xl border border-border bg-surface p-4">
...
export function Contact() {
  ...
  return (
    <section id="contact" className="scroll-mt-24 border-t border-border bg-surface py-24">
      <div className="mx-auto max-w-6xl px-5">
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[1fr_1.1fr]">
          <Reveal className="rounded-2xl p-6 panel sm:p-8">
              ...
              {links.map(({ icon: Icon, label, value, href }) => {
                ...
                return href ? (
                  <a
                    ...
                    rel="noreferrer"
                    className="block rounded-xl border border-transparent p-2 transition-colors hover:border-border hover:bg-background"
                  >
                    {content}
                  </a>
                ) : (
          ...
          <Reveal delay={90} className="rounded-2xl p-6 panel sm:p-8">
            <form onSubmit={onSubmit} className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block">
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-lg border border-input bg-background px-3.5 py-2.5 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-primary/60"
                  />
                </label>
                <label className="block">
                  <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground">
              ...
              <label className="block">
                ...
                <textarea
                  ...
                  className="mt-2 w-full resize-none rounded-lg border border-input bg-background px-3.5 py-2.5 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-primary/60"
                />
              </label>
              <button
                type="submit"
